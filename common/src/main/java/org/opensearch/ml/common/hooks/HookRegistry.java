...
public class HookRegistry {
    ...
    public <T extends HookEvent> void emit(T event) {
        ...
        if (eventCallbacks != null) {
            log.debug("Emitting {} event to {} callbacks", eventType.getSimpleName(), eventCallbacks.size());
            ...
            log.debug("No callbacks registered for event type: {}", eventType.getSimpleName());
        }
    }
