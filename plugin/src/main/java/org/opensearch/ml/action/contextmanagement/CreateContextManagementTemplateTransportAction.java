...
@Log4j2
public class CreateContextManagementTemplateTransportAction extends HandledTransportAction<
    MLCreateContextManagementTemplateRequest,
    ...
    protected void doExecute(
        ...
        try (ThreadContext.StoredContext context = client.threadPool().getThreadContext().stashContext()) {
            ...
            contextManagementTemplateService.saveTemplate(
