...
@Log4j2
public class ListContextManagementTemplatesTransportAction extends HandledTransportAction<
    MLListContextManagementTemplatesRequest,
    MLListContextManagementTemplatesResponse> {
    ...
    protected void doExecute(
        ...
        try (ThreadContext.StoredContext context = client.threadPool().getThreadContext().stashContext()) {
            ...
            contextManagementTemplateService.listTemplates(
                request.getFrom(),
                request.getSize(),
                ActionListener.wrap(templates -> {
